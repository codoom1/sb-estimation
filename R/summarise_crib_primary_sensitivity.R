...
out <- file.path(root, "outputs/final_analysis_crib_adult/parameter_sensitivity")
source(file.path(root, "R/crib_sensitivity_table.R"))
source(file.path(root, "R/crib_sensitivity_inference.R"))
...
primary_file <- file.path(root, "outputs/final_analysis_crib_adult/datasets/primary_daily_sitting.csv")
...
primary <- read_csv(file.path(root, "outputs/final_analysis_crib_adult/datasets/primary_analytic_participants.csv"),
                    show_col_types = FALSE) |> mutate(ID = as.character(ID), Dataset = as.character(Dataset))
cohort <- read_csv(file.path(root, "outputs/final_analysis_crib_adult/qc/primary_day_rule/cohort_summary.csv"), show_col_types = FALSE)
...
source(file.path(root, 'R/plot_crib_parameter_sensitivity.R'))
plot_crib_parameter_sensitivity(changes, frame, cohort, out, root)
